...
class SoonComingPage extends StatefulWidget {
  @override
  _SoonComingPageState createState() => _SoonComingPageState();
}

class _SoonComingPageState extends State<SoonComingPage> {
